...
const statusComponnet = (title: string) => {
  return (
    <Grid container spacing={2} sx={{height:'100%' , width:'100%'}}>
      <Grid size={{ xs: 12, sm: 3, md: 3, lg:1 }}>
        <Typography>{title} :</Typography>
      </Grid>
      <Grid size={{ xs: 12, sm: 9, md: 9 , lg: 11 }}>
        <Box 
            sx={{height:20, backgroundColor:'grey', position:'relative',width:'60%', borderRadius:20}}
          />
  ...
  return (
    <Box sx={{display:'flex',flexDirection:'column', backgroundColor:'pink',m:1}}>
      ...
      <Box sx={{width:'100%',height:'100%', backgroundColor:'lightblue'}}>
        ...
        <Box sx={{height:'100%', backgroundColor:'brown'}}>
           <Typography sx={{fontSize:14,width:'100%',height:'100%' }}>Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply dummy text of the printing and typesetting industry.</Typography>
        </Box>
      </Box>
